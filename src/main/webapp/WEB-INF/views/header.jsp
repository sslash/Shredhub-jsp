...
<div id="navbar-mid" class="navbar navbar-inverse navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container">
			...
			<a class="brand" href="<c:url value="/j_spring_security_logout" />" > Logout</a>
			<a class="brand" href="#">Shredhub</a>
			<div class="nav-collapse collapse">
				<ul class="nav">
					<li class=""><a href="<c:url value="/shredpool"/>">The Shredpool</a></li>
					<li class=""><a href="<c:url value="/shredder/"/><c:out value="${sessionScope.shredder.id}"/> ">Profile</a>
					...
					<li class="">
						<p class="navbar-text pull-right">
							Logged in as <a href="#" class="navbar-link"><c:out value="${sessionScope.shredder.username}"/>
							</a>
							<!--/.nav-collapse -->
					</li>
					<li class="">
						<div class="btn-group">
							...
							<ul class="dropdown-menu">								
								<c:forEach var="req" items="${battleRequests}">
									<li> <p>${req.battler.shredder.username}</p><a class="battleRequestModal" onclick="acceptBattle(${req.id});" href="#">Accept</a> </li>
							</c:forEach>
