...
<script	src="<c:url value="/resources/scripts/"/>video.min.js"></script> 
<script	src="<c:url value="/resources/scripts/"/>underscore-min.js"></script>
<script	src="<c:url value="/resources/styling/bootstrap/"/>js/bootstrap.min.js"></script>
<!-- 
