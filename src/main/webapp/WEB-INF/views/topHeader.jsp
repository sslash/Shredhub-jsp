...
<meta charset="utf-8">
<title><c:out value="${sessionScope.shredder.username}"/>'s Shredhub</title>
...
<!-- Le scripts n styles -->
<link href="<c:url value="/resources/styling/bootstrap/"/>css/bootstrap.css" 	rel="stylesheet">
<link href="<c:url value="/resources/styling/bootstrap/"/>css/prettify.css" rel="stylesheet">
<link href="<c:url value="/resources/styling/bootstrap/"/>css/docs.css" rel="stylesheet">
<link href="<c:url value="/resources/styling/"/>video-js.css" rel="stylesheet">
<link href="<c:url value="/resources/styling/"/>main.css" rel="stylesheet">
<script src="<c:url value="/resources/styling/bootstrap/"/>js/jquery.js"></script>
<link href="<c:url value="/resources/styling/bootstrap/"/>css/bootstrap-responsive.css" rel="stylesheet">
